<template>
  <div>
    ...
    <div class="app__content">
      <div class="app__item" v-for="(item, index) in picList" :key="item">
        <we-img :src="`http://image.mihui365.com/boutiqueImg/${item}`" :alt="item"></we-img>
        <p class="ignore">睡眠面膜 圣诞限定---{{ index }}</p>
        <span class="ignore">&yen; 89.99</span>
      </div>
    </div>
  </div>
</template>
